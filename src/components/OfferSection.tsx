        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {includes.map((item, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="p-6 bg-white/80 backdrop-blur-sm border-marketing-blue-200/50 hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {bonuses.map((bonus, index) => (
              <Card 
                key={index} 
                className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-200 hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
